export const FR = {
   ...
   StatisticsTransportationBuilding: "Bâtiments",
   ...
   PlayerTradeFillSuccessV2:
      "<b>%{success}/%{total}</b> des transactions ont été effectuées. Vous avez payé <b>%{fillAmount} %{fillResource}</b> et reçu <b>%{receivedAmount} %{receivedResource}</b>",
   ...
   ResourceImportImportCapV2: "Montant max.",
   ResourceImportSettings: "Transport des ressources : %{res}",
   ResourceImportCapacity: "Capacité de transport de ressource",
   PlayerTradeYouPay: "Vous payez : %{res}",
   PlayerTradeFillPercentage: "Taux de remplissage",
   ...
   UpgradeBuildingNotProducingDescV2:
      "Ce bâtiment est en cours d'amélioration - <b>la production est suspendue pendant la durée de l'amélioration</b>",
   Tutorial: "Tutoriel",
   ...
   ScrollWheelAdjustLevelTooltip:
      "Vous pouvez utiliser la molette pour ajuster le niveau lorsque votre curseur se trouve dessus.",
   Concrete: "Béton",
   ConcretePlant: "Cimenterie",
   ResourceExportBelowCap: "Exporter sous le plafond",
   ResourceExportBelowCapTooltip:
      "Permet à d'autres bâtiments de transporter une ressource à partir de ce bâtiment, même si sa quantité est inférieure au plafond",
   ResourceExportToSameType: "Exporter vers le même type",
   ResourceExportToSameTypeTooltip:
      "Permet à d'autres bâtiments du même type de transporter une ressource à partir de ce bâtiment",
   MarketTradeDescHTML:
      "Les marchés obtiennent <b>un échange supplémentaire par niveau</b>. Après avoir amélioré le marché, les échanges supplémentaires apparaîtront",
   WarehouseAutopilotSettings: "Réglages de l'autopilote",
   WarehouseAutopilotSettingsEnable: "Activer l'autopilote",
   WarehouseAutopilotSettingsRespectCapSetting: "Requiert un stockage < Cap",
   WarehouseAutopilotSettingsRespectCapSettingTooltip:
      "L'autopilote ne transporte que les ressources dont la quantité stockée est inférieure au plafond",
   Zenobia: "Zénobie",
   ZenobiaDesc: "+%{value}h Petra Warp Storage",
   PlayerTradeFillAmountMaxV2: "Remplir au max.",
   GrandBazaar: "Grand Bazar",
   GrandBazaarDesc: "Contrôlez tous les marchés en un seul endroit ! Tous les bâtiments adjacents bénéficient d'un multiplicateur de stockage de +5",
   GrandBazaarFilters: "Filtres",
   GrandBazaarFilterYouPay: "Vous payez",
   GrandBazaarFilterYouGet: "Vous recevez",
   SeaTradeUpgrade: "Échange avec les joueurs de l'autre côté de la mer. Tarif pour chaque tuile de mer : %{tariff}",
